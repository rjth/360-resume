...
macTitle = "Tools"
macText = "Designed and built experiences for both 3D and 2D environments using Unity, Framer, Sketch and Cinema4D. These digital tools are always firmly supported by hand-sketching and wireframes."
